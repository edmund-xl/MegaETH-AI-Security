...
Analyze JumpServer control-plane operations such as export, authorization, host changes, and account changes.
...
- control-plane actions are background evidence and cannot replace host execution evidence
