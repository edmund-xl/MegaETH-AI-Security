...
Detect exposed keys, tokens, and sensitive credentials in code, configuration, and commit content.
...
- matches require human confirmation
- does not assume exposed credentials are already invalid
