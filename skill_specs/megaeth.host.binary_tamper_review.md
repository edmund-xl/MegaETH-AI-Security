...
Analyze binary replacement, file tampering, and high-risk dropped-artifact behavior on hosts.

### 3. Typical Inputs

- host integrity records
- binary diff or replacement clues
...
- requires source and release-context review
- does not automatically mean attacker success
